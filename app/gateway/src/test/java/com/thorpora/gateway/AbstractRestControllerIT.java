...
public abstract class AbstractRestControllerIT
        <Resource extends RestResource, Entity extends AbstractEntity> extends AbstractIT {
    ...
    public AbstractRestControllerIT(
     ...
     * TEST POST
     */
    protected void postOne(ResourceCreator<Resource> entityCreator,
        ...
        assertThat(rscGot.getId()).isNotNull();
     ...
     */
    protected void getManyWithoutResult(Object... urlVariables) {
    ...
    public void deleteNotExist() {
        restTemplate.delete(resourceIdMapping, UUID.randomUUID());
    }
    ...
    protected void assertValidLocation(String resourceLocation,
                                       String resourceMapping,
